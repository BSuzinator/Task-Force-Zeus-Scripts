...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["rhsusf_m998_w_2dr", "rhsusf_m998_w_halftop", "rhsusf_m998_w_2dr_halftop", "C_Offroad_01_F", "B_G_Offroad_01_F", "B_mas_mar_Offroad_01_F"];
	IL_Supported_Vehicles_VAN = ["C_Van_01_box_F", "B_G_Van_01_transport_F", "C_Van_01_transport_F"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F", "rhsusf_M977A4_usarmy_wd", "rhsusf_M977A4_BKIT_usarmy_wd", "rhsusf_M977A4_BKIT_M2_usarmy_wd"];
	IL_Supported_Vehicles_KAMAZ = ["I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered", "rhsusf_M1078A1P2_B_M2_wd_fmtv_usarmy", "rhsusf_M1078A1P2_B_wd_open_fmtv_usarmy", "rhsusf_M1083A1P2_B_wd_flatbed_fmtv_usarmy", "rhsusf_M1078A1P2_wd_flatbed_fmtv_usarmy"];
	...
	IL_Supported_Vehicles_C130J = ["C130J_Cargo", "C130J", "B_T_VTOL_01_vehicle_F"];
	...
	//Supported cargo
	IL_Supported_HEMTT = ["B_Truck_01_covered_F", "B_Truck_01_transport_F", "B_Truck_01_box_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F", "B_Truck_01_mover_F", "B_Truck_01_ammo_F", "B_Truck_01_fuel_F", "B_Truck_01_medical_F", "B_Truck_01_Repair_F", "rhsusf_M977A4_usarmy_wd", "rhsusf_M977A4_BKIT_usarmy_wd", "rhsusf_M977A4_BKIT_M2_usarmy_wd"];
	IL_Supported_KAMAZ = ["rhsusf_M1078A1P2_B_M2_wd_fmtv_usarmy", "rhsusf_M1078A1P2_B_wd_open_fmtv_usarmy", "I_Truck_02_transport_F", "O_Truck_02_transport_F", "I_Truck_02_covered_F", "O_Truck_02_covered_F", "caf_HLVW_open_AR", "caf_HLVW_open", "caf_HLVW_covered_ar", "caf_HLVW_covered"];
	...
	IL_Supported_OFFROAD = ["rhsusf_m998_w_2dr", "rhsusf_m998_w_halftop", "rhsusf_m998_w_2dr_halftop", "C_Offroad_01_F", "B_G_Offroad_01_F", "B_G_Offroad_01_armed_F", "JTF2_Offroad_armed_01", "B_mas_mar_Offroad_01_F", "B_mas_mar_Offroad_01_armed_F"];
	...
	IL_Supported_Quadbike = ["rhsusf_mrzr4_d", "I_Quadbike_01_F", "C_Quadbike_01_F", "O_Quadbike_01_F", "B_G_Quadbike_01_F", "B_Quadbike_01_F", "CAF_Quadbike_OD", "CAF_Quadbike_AR", "Marinir_Quadbike_01_FG", "B_mas_mar_Quadbike_01_F"];
	IL_Supported_Supply_Crate = ["B_CargoNet_01_ammo_F", "B_supplyCrate_F", "IG_supplyCrate_F", "O_supplyCrate_F", "I_supplyCrate_F", "C_supplyCrate_F"];
	...
	IL_Supported_Rubberboat = ["CUP_B_Zodiac_USMC", "I_Boat_Transport_01_F", "O_Boat_Transport_01_F", "B_G_Boat_Transport_01_F", "B_Boat_Transport_01_F", "C_Rubberboat", "O_Lifeboat", "B_Lifeboat", "Marinir_duck_base_F", "B_mas_mar_Boat_Transport_01_F"];
	...
	IL_Supported_Huron = ["B_Slingload_01_Fuel_F", "B_Slingload_01_Cargo_F", "B_Slingload_01_Ammo_F", "B_Slingload_01_Repair_F"];
	//TODO
	...
	IL_Supported_Cargo_NonVeh_Kamaz = IL_Supported_Huron + IL_Supported_Supply_Crate + IL_Supported_Veh_Ammo + IL_Supported_Barrel + IL_Supported_Tank + IL_Supported_Box_H1 + IL_Supported_Box_H2 + IL_Supported_Cargo20;
	IL_Supported_Cargo_Kamaz = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_Cargo_NonVeh_Kamaz;
	
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Cargo_Veh_Kamaz + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Rubberboat;
...
//	END IL_Init_Veh
	...
	IL_Init_Box =
	{
		...
		if (_obj_type in IL_Supported_Huron) then
        {
            _obj setVariable["slots", 6, true];
            _obj setVariable["cargo_offset", 2.6, true];//HEMETT Box ~2.09281
            //LOCAL
            //_obj setMass 5000;
            [_obj, 5000] call IL_SetNewMass;
        };
